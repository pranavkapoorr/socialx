                        ...
                        children: <Widget>[
                              ...
                              InkWell(
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: <Widget>[
                                      Icon(Icons.data_usage,color: Colors.grey),
                          ...
                          myContainer(
                            ...
                            AboutListTile(
                              ...
                              applicationName: "SocialX",
                              applicationIcon: Icon(Icons.people,color: Colors.grey),
                              child: Text("SocialX",style: TextStyle(color: Colors.black,fontSize: 14.0,fontWeight: FontWeight.normal)),
                            ),
                          )
                        ],
                      ),
